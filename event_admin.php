...
<body style= "margin: 50px;">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            $fetchEventsQuery = "SELECT * FROM event WHERE UIN = {$uin}";
            $result = $conn->query($fetchEventsQuery);

            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td contenteditable='true'>" . $row['Event_ID'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['UIN'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['Program_Num'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['Start_Date'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['Start_Time'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['Location'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['End_Date'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['End_Time'] . "</td>";
                    echo "<td contenteditable='true'>" . $row['Event_Type'] . "</td>";
